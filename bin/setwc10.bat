...
set WATCOM=%WC32DIR%
set COMP=W3
set INCLUDE=%WC32DIR%\H;%WC32DIR%\H\NT;%stdinclude%
set WCVER=950
set MODE=n
goto done
...
rem SET LIBDOS=%WC16DIR%\lib286;%WC16DIR%\lib286\dos
rem SET LIBOS2=%WC16DIR%\lib286;%WC16DIR%\lib286\os2;%TOOLKT13LIB%
rem SET LIBOS2FLAT=%WC32DIR%\lib386;%WC32DIR%\lib386\os2;%TOOLKT20LIB%
